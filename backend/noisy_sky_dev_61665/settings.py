"""
Django settings for noisy_sky_dev_61665 project.
...
ROOT_URLCONF = 'noisy_sky_dev_61665.urls'
...
WSGI_APPLICATION = 'noisy_sky_dev_61665.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_sky_dev_61665 API",
    "DESCRIPTION": "API documentation for noisy_sky_dev_61665 App",
    "VERSION": "v1",
}
